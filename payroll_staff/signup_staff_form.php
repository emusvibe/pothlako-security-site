			<form id="signin_teacher" class="form-signin" method="post" >
					<h3 class="form-signin-heading"><i class="icon-lock"></i> Activate Payroll Staff Account</h3>
					...
					<select name="department_id" class="input-block-level span12">
						<option></option>
						<?php
                                                $query = mysqli_query($con,"select * from department where department_id = 9")or die(mysql_error());
