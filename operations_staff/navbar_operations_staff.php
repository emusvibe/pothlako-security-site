	<div class="navbar navbar-fixed-top navbar-inverse">
           <div class="navbar-inner">
               <div class="container-fluid">
                   ...
                   <a class="brand" href="#"><img src="../admin/images/logo_lil.png" alt=""/>&nbsp;&nbsp;&nbsp;Pothlako Security Services:&nbsp;&nbsp;&nbsp;Operations Department</a>
							<div class="nav-collapse collapse">
								<ul class="nav pull-right">
                                                            <?php $query= mysqli_query($con,"select * from operations_staff where operations_staff_id = '$session_id'")or die(mysql_error());
