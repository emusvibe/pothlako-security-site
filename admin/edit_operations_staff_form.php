   <div class="row-fluid">
       <a href="operations_staff.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Staff</a>
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Operations Staff</div>
                            </div>
...
<!--								
										...
										-->
									<?php
									$query = mysqli_query($con,"select * from operations_staff where operations_staff_id = '$get_id' ")or die(mysql_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($con,"select * from operations_staff join  department")or die(mysql_error());
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								$query = mysqli_query($con,"select * from operations_staff where firstname = '$firstname' and lastname = '$lastname' ")or die(mysql_error());
								...
								mysqli_query($con,"update operations_staff set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where operations_staff_id = '$get_id' ")or die(mysql_error());	
								
								?>
								<script>
							 	window.location = "operations_staff.php"; 
								</script>
								<?php   }} ?>
