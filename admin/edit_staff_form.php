   <div class="row-fluid">
       <a href="admin_staff.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Staff</a>
                        <!-- block -->
                        <div class="block">
...
<!--								
										...
										-->
									<?php
									$query = mysqli_query($con,"select * from admin_staff where staff_id = '$get_id' ")or die(mysql_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($con,"select * from admin_staff join  department")or die(mysql_error());
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								mysqli_query($con,"update admin_staff set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where staff_id = '$get_id' ")or die(mysql_error());	
