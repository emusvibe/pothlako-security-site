<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li class="active"><a href="dasboard_staff.php"><i class="icon-chevron-right"></i><i class="fa fa-group"></i>&nbsp;My Dashboard
		...
		<?php
			...
			<?php if($count_message == '0'){
                ...
                $count_message = mysqli_num_rows($message_query);
                ?>
		<li class=""><a href="#"><i class="icon-chevron-right"></i><i class="fa fa-suitcase"></i>&nbsp;Requisitions
                                    <?php if($count_message == '0'){
				}else{ ?>
