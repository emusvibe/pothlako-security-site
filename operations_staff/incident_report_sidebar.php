<div class="span3" id="sidebar">
	...
	<?php
                ...
                ?>	
            <li ><a href="dasboard_operations_staff.php"><i class="icon-chevron-right"></i><i class="fa fa-group"></i>&nbsp;My Dashboard
...
<!--                 <li class=""><a href="hr_notification.php"><i class="icon-chevron-right"></i><i class="icon-info-sign"></i>&nbsp;Notification
			<?php if($count_message == '0'){
                ...
                <?php
                $message_query = mysqli_query($con,"select * from ps_leaves where leave_status='' ")or die(mysql_error());
                $count_message = mysqli_num_rows($message_query);
                ?>
		 ...
		 <?php
                ...
                $count_message = mysqli_num_rows($message_query);
                ?>
                    <li class=""><a href="requisition_message_controlroom.php"><i class="icon-chevron-right"></i><i class="fa fa-suitcase"></i>&nbsp;Requisitions
                                    <?php if($count_message == '0'){
				}else{ ?>
					&nbsp;<span class="badge badge-important"><?php echo $count_message; ?></span>
				<?php } ?>
                    </a></li>
                    <li class=""><a href="warnings.php"><i class="icon-chevron-right"></i><i class="fa fa-warning"></i>&nbsp;Warnings </a></li> 
		...
		<li class=""><a href="#"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Duty Roster</a></li>
                <li class="active"><a href="incident_report.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Incident Reports</a></li>
