                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="">
                                                                                    <a href="requisition_message_admin.php"><i class="fa fa-envelope">&nbsp;</i>inbox</a>
										</li>
										<li class="active">
                                                                                    <a href="sent_message_admin.php"><i class="fa fa-envelope">&nbsp;</i>Sent messages</a>
										</li>
										</ul>
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('create_message_admin.php') ?>
            </div>
