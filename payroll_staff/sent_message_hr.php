                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="">
                                                                                    <a href="requisition_message_hr.php"><i class="fa fa-envelope">&nbsp;</i>inbox</a>
										</li>
										<li class="active">
                                                                                    <a href="sent_message_hr.php"><i class="fa fa-envelope">&nbsp;</i>Sent messages</a>
										</li>
										</ul>
									
								<?php
								 $query_announcement = mysqli_query($con,"select * from message_sent
                                                               LEFT JOIN admin_staff ON admin_staff.staff_id = message_sent.reciever_id
