	...
	<div class="row-fluid">
									...
									<div class="control-group">
                                          ...
                                          <div class="controls">
                                            <select name="teacher_id"  class="chzn-select" required>
                                             	<option></option>
											<?php
											$query = mysqli_query($con,"select * from admin_staff order by firstname");
											while($row = mysqli_fetch_array($query)){
											
											?>
											
											<option value="<?php echo $row['staff_id']; ?>"><?php echo $row['firstname']; ?> <?php echo $row['lastname']; ?> </option>
			...
			jQuery("#send_message").submit(function(e){
					...
					$.ajax({
						...
						var delay = 2000;
							setTimeout(function(){ window.location = 'requisition_message_hr.php'  }, delay);  
