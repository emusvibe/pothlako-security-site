<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="teacher_message.php"><i class="icon-chevron-right"></i><i class="fa fa-envelope-o"></i>&nbsp;Message</a></li> 
		<li class="active"><a href="teacher_backack.php"><i class="icon-chevron-right"></i><i class="fa fa-suitcase"></i>&nbsp;Backpack</a></li> 
