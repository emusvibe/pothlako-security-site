	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysqli_query($con,"select * from guards LEFT JOIN post ON guards.post_id = post.post_id where status = 'Registered' ORDER BY guards.guard_id DESC") or die(mysql_error());
