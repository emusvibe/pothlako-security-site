   <div class="row-fluid">
       <a href="payroll_staff.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Add Staff</a>
                        <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Payroll Staff</div>
                            </div>
...
<!--								
										...
										-->
									<?php
									$query = mysqli_query($con,"select * from payroll_staff where payroll_staff_id = '$get_id' ")or die(mysql_error());
									...
									?>
                                          ...
                                          <div class="controls">
											...
											<?php
											$query_teacher = mysqli_query($con,"select * from payroll_staff join  department")or die(mysql_error());
				   ...
				   <?php
                            if (isset($_POST['update'])) {
								...
								$query = mysqli_query($con,"select * from payroll_staff where firstname = '$firstname' and lastname = '$lastname' ")or die(mysql_error());
								...
								mysqli_query($con,"update payroll_staff set firstname = '$firstname' , lastname = '$lastname' , department_id = '$department_id' where payroll_staff_id = '$get_id' ")or die(mysql_error());	
								
								?>
								<script>
							 	window.location = "payroll_staff.php"; 
								</script>
								<?php   }} ?>
