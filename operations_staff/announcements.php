        ...
        <div class="container-fluid">
            <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									mysqli_query($con,"insert into teacher_class_announcements (teacher_class_id,teacher_id,content,date) values('$get_id','$session_id','$content',NOW())")or die(mysql_error());
									mysqli_query($con,"insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','Add Annoucements',NOW(),'announcements_student.php')")or die(mysql_error());
									?>
									<script>
				...
				<div class="span4 row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left"><i class="fa fa-list-ul"></i> Announcements</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								 <?php
