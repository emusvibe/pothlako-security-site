<div class="span3" id="">
	<div class="row-fluid">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="hr_message.php">For Payroll</a></li>
									</ul>
								...
								<form method="post" id="send_message_student">
									<div class="control-group">
											<label>To:</label>
                                          <div class="controls">
                                            <select name="payroll_staff_id"  class="chzn-select" required>
                                             	<option></option>
			...
			jQuery("#send_message_student").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "send_message_hr_to_payroll.php",
						data: formData,
						success: function(html){
						
						$.jGrowl("Message Successfully Sent", { header: 'Message Sent' });
						var delay = 2000;
							setTimeout(function(){ window.location = 'hr_message.php'  }, delay);  
