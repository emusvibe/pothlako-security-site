...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('requisition_message_sidebar.php'); ?>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="">
                                                                                    <a href="requisition_message_controlroom.php"><i class="fa fa-envelope">&nbsp;</i>inbox</a>
										</li>
										<li class="active">
                                                                                    <a href="sent_message_control.php"><i class="fa fa-envelope">&nbsp;</i>Sent messages</a>
										</li>
										</ul>
									
								<?php
								 $query_announcement = mysqli_query($con,"select * from message_sent
                                                                LEFT JOIN operations_staff ON operations_staff.operations_staff_id = message_sent.reciever_id
	...
	$(document).ready( function() {
		...
		var id = $(this).attr("id");
			...
			return false;
				...
				<?php include('create_message_control.php') ?>
            </div>
